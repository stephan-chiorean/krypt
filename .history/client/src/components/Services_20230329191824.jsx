    ...
    <div className='flex w-full justify-center items-center gradient-bg-services'>
      ...
      <div className='flex-1 flex flex-col justify-start items-center'>
        ...
        <ServiceCard
          ...
          subtitle="Only at Krypt will you find top of the line rates without sacrificing efficiency."
        />
        <ServiceCard
          color='bg-[#f84550]'
          title='The Best Service'
          icon={<RiHeart2Fill fontSize={21} className='text-white' />}
          subtitle="We know things happen, and we're here for you when they do - always putting you first."
        />
      </div>
    </div>
  );
